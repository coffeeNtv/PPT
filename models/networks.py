...
def define_G(input_nc, output_nc, ngf, model_type, norm, use_dropout=False, init_type='normal',
...
# Discriminator
def define_D(input_nc, ndf, n_layers_D=3, norm='batch', init_type='normal', init_gain=0.02, no_antialias=False, gpu_ids=[], opt=None):
...
def define_F(input_nc, norm='batch', use_dropout=False, init_type='normal', init_gain=0.02, no_antialias=False, gpu_ids=[], opt=None):

    net = PatchSampleF(use_mlp=True, init_type=init_type, init_gain=init_gain, gpu_ids=gpu_ids, nc=256, opt=opt)
    return init_net(net, init_type, init_gain, gpu_ids)
...
class ResnetGenerator(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, ngf=64, norm_layer=nn.InstanceNorm2d, use_dropout=False, n_blocks=6, padding_type='reflect', no_antialias=False, no_antialias_up=False, opt=None):
        ...
        model = [nn.ReflectionPad2d(3),
                 ...
                 norm_layer(ngf),
                 nn.ReLU(True)]
        n_downsampling = getattr(opt, 'n_downsampling', 4)
